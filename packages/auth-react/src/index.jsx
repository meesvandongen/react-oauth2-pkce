...
const authConfig = {
	...
	authorizationEndpoint:
		"https://keycloak.ofstad.xyz/realms/master/protocol/openid-connect/auth",
	tokenEndpoint:
		"https://keycloak.ofstad.xyz/realms/master/protocol/openid-connect/token",
	logoutEndpoint:
		"https://keycloak.ofstad.xyz/realms/master/protocol/openid-connect/logout",
...
function LoginInfo() {
	...
	return (
		<>
			...
			<button
				onClick={() =>
					logIn("customLoginState", { scope: "profile", something: 123 })
				}
			>
			...
			{token ? (
				<>
					<button
						onClick={() => logOut("rememberThis", idTokenData?.session_state)}
					>
						Log out
					</button>
					<span style={{ margin: "0 10px" }}>
						...
						{new Date(
							Number(localStorage.getItem("ROCP_tokenExpire")) * 1000,
						).toLocaleTimeString()}
					</span>
...
root.render(
	<React.StrictMode>
		<div>
			<h1>Demo using the &apos;@mvd/auth-react&apos; package</h1>
			<p>
				Github:{" "}
				<a href="https://github.com/soofstad/react-oauth2-pkce">
					https://github.com/soofstad/react-oauth2-pkce
				</a>
			</p>
			<p>
				NPM:{" "}
				<a href="https://www.npmjs.com/package/@mvd/auth-react">
					https://www.npmjs.com/package/@mvd/auth-react
				</a>
			</p>
		</div>
